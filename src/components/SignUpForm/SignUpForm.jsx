    ...
    <>
      <div className={s.formWrap}>
        <form className={s.form} onSubmit={handleSubmit(onSubmit)}>
          ...
          <label>
            <span className={`${s.label} ${s.firstLabel}`}>
              Ім’я<span className={s.requiredField}>*</span>
            </span>
            <input
              className={s.input}
              name="name"
          ...
          <label>
            <span className={s.label}>
              Електронна адреса<span className={s.requiredField}>*</span>
            </span>
            <input
              className={s.input}
              type="email"
          ...
          <label>
            <span className={s.label}>
              Пароль<span className={s.requiredField}>*</span>
            </span>
            <input
              className={s.input}
              type="password"
          ...
          <label>
            <span className={s.label}>
              Підтвердити пароль<span className={s.requiredField}>*</span>
            </span>
            <input
              className={s.input}
              type="password"
          ...
          <p className={s.logInMessage}>
            Вже з нами?{' '}
            <NavLink className={s.navLink} exact to="/login">
              Увійти
            </NavLink>
          </p>
        </form>
